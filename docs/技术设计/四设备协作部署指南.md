...
FLOWMUSE_LAYOUT_V3_BASE_URL=https://ark.cn-beijing.volces.com/api/v3
FLOWMUSE_LAYOUT_V3_API_KEY=你的豆包方舟 API Key
FLOWMUSE_LAYOUT_V3_MODEL=你的 V3 排版模型
FLOWMUSE_LAYOUT_V3_TIMEOUT_SECONDS=120
