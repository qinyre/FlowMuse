...
class OSSyntax {
  ...
  // HarmonyOS (flutter_ohos) — 非 Dart 上游官方 OS,但 flutter_ohos 工具链
  // 会以 "ohos" 作为目标 OS 触发 native-assets hooks。加此枚举避免
  // objective_c 等包的 hook 在解析 targetOS 时抛 FormatException。
