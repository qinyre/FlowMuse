...
final class OS {
  ...
  // HarmonyOS (flutter_ohos) — 非 Dart VM 上游官方 OS,但 flutter_ohos 工具链
  // 以 "ohos" 作为目标 OS。加此枚举使其被 OS.values/OSSyntax 识别,避免
  // native-assets hooks(如 objective_c)在 OS.fromSyntax 解析时抛 FormatException。
  // 对其他平台零影响:仅多一个枚举值,原有 6 个平台行为不变。
